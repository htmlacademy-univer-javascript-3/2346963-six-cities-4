...
import { CITY, POINTS, offers } from '../../mocks/offers';
      ...
      <main className="page__main page__main--offer">
        ...
        <div className="container">
          <section className="near-places places">
            ...
            <ListOfOffers listClassName='near-places__list places__list' className='near-places' offers={offers.slice(0, 3)} forFavoriteList={false}/>
          </section>
        </div>
      </main>
    </div>
